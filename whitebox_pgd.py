...
parser.add_argument("--config", default="experiments/defenses/resisc/defensegan_improve.yml", help="config file")
...
output_dir = (cfg.defense.path).strip('/') + f'_pgd_{args.eps}'
